  ...
  render(){
    return (
      <div className="main-container">
        ...
        <img src="../../assets/images/weight.png" height="75" width="75" className="home-icon"/>
          <h2 className="section-title"> Workouts </h2>
        </div>

        <div className="home-cycle-container" onClick={this.CycleLink}>
            <img src="../../assets/images/cycle-icon.png" height="75" width="75" className="home-icon"/>
          <h2 className="section-title"> Cycles </h2>
        </div>

        <div className="home-athlete-container" onClick={this.AthleteLink}>
          <img src="../../assets/images/athletes-icon.png" height="75" width="75" className="home-icon"/>
